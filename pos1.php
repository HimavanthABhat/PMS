...
<body>
	...
	?>
			...
			<form method="post">
					...
					<input type="number" name="medid" value="<?php if(isset($row4[0])){ echo $row4[0];}else echo "" ?>"readonly ><br><br>
					
					<label for="mdname">Medicine Name:</label>
					<input type="text" name="mdname" value="<?php if(isset($row4[1])){ echo $row4[1];}else echo "" ?>" readonly><br><br>
					
					</div>
					<div class="column">
					
					<label for="mcat">Category:</label>
					<input type="text" name="mcat" value="<?php if(isset($row4[3])){ echo $row4[3];}else echo "" ?>" readonly><br><br>
					
					<label for="mloc">Location:</label>
					<input type="text" name="mloc" value="<?php if(isset($row4[5])){ echo $row4[5];}else echo "" ?>" readonly><br><br>
					
					</div>
					<div class="column">
					
					<label for="mqty">Quantity Available:</label>
					<input type="number" name="mqty" value="<?php if(isset($row4[2])){ echo $row4[2];}else echo "" ?>" readonly><br><br>
					
					<label for="mprice">Price of One Unit:</label>
					<input type="number" name="mprice" value="<?php if(isset($row4[4])){ echo $row4[4];}else echo "" ?>" readonly><br><br>
